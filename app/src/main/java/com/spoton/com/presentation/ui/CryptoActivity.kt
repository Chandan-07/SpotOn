...
class CryptoActivity : ComponentActivity() {
    ...
    @Composable fun CryptoHomeScreen() {
        ...
        CryptoFragment(viewModelCompose)
    }
    ...
    @Composable
    fun CryptoFragment(viewModelCompose: CryptoViewModel) {
            ...
            Scaffold(topBar = {
                ...
                when (val response = viewModelCompose.cryptoListState.collectAsState().value) {
                    ...
                    is CryptoUIViewState.CryptoSuccessState -> {
                        CryptoList(response.cryptoList)
                    }
                }
            })
        }
